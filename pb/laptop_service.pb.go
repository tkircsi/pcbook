...
var file_laptop_service_proto_rawDesc = []byte{
	...
	0x70, 0x74, 0x6f, 0x70, 0x52, 0x06, 0x6c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x32, 0xb7, 0x01, 0x0a,
...
var file_laptop_service_proto_goTypes = []interface{}{
	...
	(*Laptop)(nil),               // 4: pcbook.pb.Laptop
	(*Filter)(nil),               // 5: pcbook.pb.Filter
}
var file_laptop_service_proto_depIdxs = []int32{
	4, // 0: pcbook.pb.CreateLaptopRequest.laptop:type_name -> pcbook.pb.Laptop
	5, // 1: pcbook.pb.SearchLaptopRequest.filter:type_name -> pcbook.pb.Filter
	4, // 2: pcbook.pb.SearchLaptopResponse.laptop:type_name -> pcbook.pb.Laptop
	0, // 3: pcbook.pb.LaptopService.CreateLaptop:input_type -> pcbook.pb.CreateLaptopRequest
	2, // 4: pcbook.pb.LaptopService.SearchLaptop:input_type -> pcbook.pb.SearchLaptopRequest
	1, // 5: pcbook.pb.LaptopService.CreateLaptop:output_type -> pcbook.pb.CreateLaptopResponse
	3, // 6: pcbook.pb.LaptopService.SearchLaptop:output_type -> pcbook.pb.SearchLaptopResponse
